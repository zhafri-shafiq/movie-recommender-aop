...
public class AccessCheckAspect {
    ...
    @Before("io.datajek.springaop.movierecommenderaop.aspect.JoinPointConfig.movieBeanPointcut()") //intercepting bean using @Pointcut
    //@Before("io.datajek.springaop.movierecommenderaop.aspect.JoinPointConfig.businessLayerPointcut()") //intercepting business layer using @Pointcut
    //@Before("io.datajek.springaop.movierecommenderaop.aspect.JoinPointConfig.allLayersPointcut()") //intercepting all layers using @Pointcut
